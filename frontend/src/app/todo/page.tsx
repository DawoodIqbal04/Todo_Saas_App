                ...
                {tasks.map((task) => (
                  <li key={task.id} className="flex items-center justify-between bg-white dark:bg-white/25 border border-white p-4 rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      <button onClick={() => setEditingTask(task)} className="border border-white/60 cursor-pointer rounded-full p-2 text-blue-500 hover:text-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                          <path d="M12 20h9" />
                          <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />
                        </svg>
                      </button>
                      <button onClick={() => deleteTask(task.id)} className="border border-white/60 cursor-pointer rounded-full p-2 text-red-500 hover:text-red-700">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                          <path d="M3 6h18" />
          ...
          <div className="bg-white dark:bg-white/10 border border-white/30 rounded-lg p-6 w-full max-w-md">
            ...
            <div className="grid gap-4">
              ...
              <div className="flex items-center justify-end gap-4">
                <div className="w-20 h-10 cursor-pointer bg-gray-300 rounded-md flex items-center relative overflow-hidden group">
              ...
              <div className="absolute w-full h-full bg-red-600 right-0 rounded-[50%] transition-all duration-500 bottom-[-200%] group-hover:rounded-none group-hover:bottom-0"></div>
                ...
                <div className="w-20 h-10 cursor-pointer bg-blue-500 rounded-md flex items-center relative overflow-hidden group">
